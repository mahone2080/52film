...
use backend\models\FilmStudioSearch;
...
class FilmStudioController extends Controller
{
    ...
    /**
     * Creates a new FilmStudio model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new FilmStudio();
    ...
    /**
     * Updates an existing FilmStudio model.
    ...
    /**
     * Deletes an existing FilmStudio model.
